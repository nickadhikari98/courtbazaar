...
export default function BulkPricingOffer() {
  return (
    <div className="landing-bulk-offer">
      ...
      <h2 className="landing-bulk-offer-title mt-3">Need Bulk Printing?</h2>
      <p className="landing-bulk-offer-subtitle">
        Get special pricing for Law Firms, Chambers and Litigation Teams — volume discounts available for
