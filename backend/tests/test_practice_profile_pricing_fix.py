...
def test_pricing_and_experience_bracket_survive_a_second_load():
    async def body():
        ...
        try:
            ...
            payload = ProxyCounselProfileUpdate(
                pricing={"district": {"urgent": 2500}, "high_court": {"full_day": 1500}},
            ...
            assert updated["pricing"] == {"district": {"urgent": 2500}, "high_court": {"full_day": 1500}}
            ...
            assert reloaded["pricing"] == {"district": {"urgent": 2500}, "high_court": {"full_day": 1500}}
            ...
            assert updated2["pricing"] == {"district": {"urgent": 2500}, "high_court": {"full_day": 1500}}
